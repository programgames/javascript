...
function startup() {
    var zone = document.getElementsByTagName("divImages")[0];
    zone.addEventListener("touchstart", handleStart, false);
    zone.addEventListener("touchend", handleEnd, false);
    zone.addEventListener("touchcancel", handleCancel, false);
    zone.addEventListener("touchleave", handleLeave, false);
    zone.addEventListener("touchmove", handleMove, false);
}
